...
export function PageWithJSbasedForm({article}) {
    ...
    const addComment = async (event) => {
        ...
        if(check.toString() === com.toString()){
            ...
            var button = document.createElement(ColorButton);
            button.innerHTML = "Clear";
            
            //var button = React.createElement(Button1, {variant: 'contained',id: 'button'+commentId, onClick: {resolve} }, "Clear");
            //console.log(button);
          ...
          onClick={logOut}>
            ...
            <div className={styles.comments}>
                <form onSubmit={submit}>
                    <Typography variant='h4' color='white'>Overall Comments</Typography> <br></br>
