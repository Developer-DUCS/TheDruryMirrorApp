...
async function handleMiddleware(req, options = {}, onSuccess) {
  var _options$pages$signIn, _options$pages, _options$pages$error, _options$pages2, _ref, _options$trustHost, _req$headers$get, _options$secret, _options$jwt, _options$cookies, _options$cookies$sess, _await$options$callba, _options$callbacks, _options$callbacks$au;
  ...
  let authPath;
  const url = (0, _node.getURL)(null, options.trustHost, (_req$headers$get = req.headers.get("x-forwarded-host")) !== null && _req$headers$get !== void 0 ? _req$headers$get : req.headers.get("host"));
  if (url instanceof URL) authPath = (0, _parseUrl.default)(url).path;else authPath = "/api/auth";
